...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var script, body, landing, mainContent,
        t1 = document,
      ...
      B.ScriptElement_methods.set$defer(script, true);
      t1.head.appendChild(script).toString;
      body = t1.body;
      body.className = "dark-theme";
      landing = t1.createElement("div");
      landing.id = "landing";
      B.DivElement_methods.setInnerHtml$1(landing, '      <div class="landing-content">\n        <img src="https://upload.wikimedia.org/wikipedia/commons/7/7e/Dart-logo.png" alt="Dart Logo" class="landing-image">\n        <h1>Bienvenido al Manual Interactivo de Dart</h1>\n        <p>Dart es un lenguaje de programaci\xf3n moderno, desarrollado por Google, que potencia el desarrollo de aplicaciones web y m\xf3viles. \n        Gracias a su sintaxis limpia y caracter\xedsticas avanzadas, Dart te permite construir interfaces impresionantes, manejar datos de forma eficiente y crear aplicaciones escalables.</p>\n        <p>Explora este portal interactivo, donde encontrar\xe1s ejemplos pr\xe1cticos, comparaciones entre el uso correcto e incorrecto y datos complementarios que enriquecer\xe1n tu aprendizaje.</p>\n        <button class="toggle-enter" id="enter-btn">Entrar al Manual</button>\n      </div>\n    ');
      body.appendChild(landing).toString;
      mainContent = t1.createElement("div");
      mainContent.id = "main-content";
      B.DivElement_methods.setInnerHtml$1(mainContent, '      <header>\n        <h1>\ud83d\udcd8 Aprende Dart Interactivamente</h1>\n        <nav>\n          <ul class="menu">\n            <li class="menu-item" data-section="introduccion">Introducci\xf3n</li>\n            <li class="menu-item" data-section="clases">Clases y M\xe9todos</li>\n            <li class="menu-item" data-section="listas">Listas</li>\n            <li class="menu-item" data-section="mapas">Mapas y Diccionarios</li>\n            <li class="menu-item" data-section="herencia">Herencia</li>\n            <li class="menu-item" data-section="constructores">Constructores</li>\n            <li class="menu-item" data-section="factory">Constructores Factory</li>\n            <li class="menu-item" data-section="busquedas">B\xfasquedas en Listas</li>\n            <li class="menu-item" data-section="operadores">Operadores</li>\n            <li class="menu-item" data-section="excepciones">Excepciones</li>\n            <li class="menu-item" data-section="json">Manejo de JSON</li>\n            <li class="menu-item" data-section="practica">Pr\xe1ctica</li>\n            <li class="menu-item" data-section="practica-completa">Pr\xe1ctica Avanzada</li>\n          </ul>\n        </nav>\n        <div class="theme-toggle-container">\n          <span>Modo Oscuro</span>\n          <label class="switch">\n            <input type="checkbox" id="theme-toggle">\n            <span class="slider"></span>\n          </label>\n          <span>Modo Claro</span>\n        </div>\n      </header>\n      <main>\n        <!-- Secci\xf3n: Introducci\xf3n -->\n        <section id="introduccion" class="content-section">\n          <h2>\ud83d\ude80 Introducci\xf3n a Dart</h2>\n          <p>Dart es un lenguaje vers\xe1til que sirve de base para el desarrollo con Flutter, permitiendo crear aplicaciones de alto rendimiento y interfaces de usuario atractivas.</p>\n          <div class="example-container">\n            <button class="toggle-example">Ver ejemplos</button>\n            <div class="example">\n              <strong class="correct-label">\u2705 Correcto:</strong>\n              <pre><code>// Punto de entrada del programa\nvoid main() {\n  print("\xa1Hola, Dart!"); // Uso de la funci\xf3n print para mostrar en consola\n}</code></pre>\n              <strong class="incorrect-label">\u274c Incorrecto:</strong>\n              <pre><code>// \'echo\' no es v\xe1lido en Dart, se usa print en su lugar\nvoid main() {\n  echo "\xa1Hola, Dart!";\n}</code></pre>\n              <div class="complement-info">\n                <em>Dato complementario:</em> La funci\xf3n <code>main()</code> es el punto de entrada en Dart y es esencial para iniciar cualquier programa.\n              </div>\n            </div>\n          </div>\n        </section>\n        <!-- M\xe1s secciones aqu\xed ... -->\n      </main>\n      <footer>\n        <p>\xa9 2025 Manual Interactivo de Dart</p>\n        <div id="info">\n          <p>Nombre: Juan, Edad: 25</p>\n        </div>\n      </footer>\n    ');
      body.appendChild(mainContent).toString;
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  (function inheritance() {
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.DivElement, A.FormElement, A.ScriptElement, A.SelectElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement]);
